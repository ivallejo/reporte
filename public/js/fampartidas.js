...
// arrData
      btnDownload.onclick = function () {
            ...
            let cabeceras = `GRUPO DE PARTIDAS¦${hejecucion2020.innerHTML}¦${hejecucion2021.innerHTML}¦VARIACIÓN 2020 VS 2021`.split("¦");
...
function btnSearch() {
      ...
      $('.btnsearch').click( async function() {
            ...
            hejecucion2020.innerHTML = `EJECUCIÓN ${mesDesdeTexto}-${mesHastaTexto} 2020`
            hejecucion2021.innerHTML = `EJECUCIÓN ${mesDesdeTexto}-${mesHastaTexto} 2021`
            
            fejecucion2020.innerHTML = `EJECUCIÓN ${mesDesdeTexto}-${mesHastaTexto} 2020`
            fejecucion2021.innerHTML = `EJECUCIÓN ${mesDesdeTexto}-${mesHastaTexto} 2021`
