...
function configFile() {
      $('#file').customFile({
            ...
            filePicker : '<p><h3>Adjuntar Excel</h3></p>'
                        +'<p>aqu&iacute;</p>',
            callbacks : {
                        onSuccess : function(item, callback){
                              try { 
                                    ...
                                    let files = item.fileList, f = files[0];
                                    ...
                                    reader.onload = function (e) {
                                          ...
                                          let trama = '';
                                          try {
                                                let XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[workbook.SheetNames[0]], { range: 3, raw: true });
                                                // wbk = XL_row_object;
                                                // debugger
                                                XL_row_object.forEach((row) => {
                                                      if ( row.Ledger == undefined ) {
                                                            let elements = document.querySelectorAll(".cif-file-row")
                                                            elements[elements.length -1].remove();
                                                            throw BreakException;
                                                      }
                                                      item = {
                                                            Ledger: row.Ledger == undefined ? '' :  row.Ledger,
                                                            Presupuesto: row.Presupuesto == undefined ? '' :  row.Presupuesto,
                                                            Periodo_Presupuestal: row['Periodo Presupuestal'] == undefined ? '' :  row['Periodo Presupuestal'],
                                                            Nivel_0_Cod: row['Nivel 0 Cod'] == undefined ? '' :  row['Nivel 0 Cod'],
                                                            Nivel_1_COD: row['Nivel 1 COD'] == undefined ? '' :  row['Nivel 1 COD'],
                                                            Nivel_1_DESC: row['Nivel 1 DESC'] == undefined ? '' :  row['Nivel 1 DESC'],
                                                            Nivel_2_COD: row['Nivel 2 COD'] == undefined ? '' :  row['Nivel 2 COD'],
                                                            Nivel_2_DESC: row['Nivel 2 DESC'] == undefined ? '' :  row['Nivel 2 DESC'],
                                                            Nivel_4_COD: row['Nivel 4 COD'] == undefined ? '' :  row['Nivel 4 COD'],
                                                            Nivel_4_DESC: row['Nivel 4 DESC'] == undefined ? '' :  row['Nivel 4 DESC'],
                                                            Mes_Contable_ID_MES: row['Mes Contable ID_MES'] == undefined ? '' :  row['Mes Contable ID_MES'],
                                                            Mes_Contable_mesN: row['Mes Contable mesN'] == undefined ? '' :  row['Mes Contable mesN'],
                                                            Fecha_Contable: row['Fecha Contable'] == undefined ? '' :  row['Fecha Contable'],
                                                            Año_Fiscal: row['Año Fiscal'] == undefined ? '' :  row['Año Fiscal'],
                                                            Moneda: row['Moneda'] == undefined ? '' :  row['Moneda'],
                                                            Unidad_COD: row['Unidad COD'] == undefined ? '' :  row['Unidad COD'],
                                                            Unidad_DESC: row['Unidad DESC'] == undefined ? '' :  row['Unidad DESC'],
                                                            Actividad_COD: row['Actividad COD'] == undefined ? '' :  row['Actividad COD'],
                                                            Actividad_DESC: row['Actividad DESC'] == undefined ? '' :  row['Actividad DESC'],
                                                            Sede_COD: row['Sede COD'] == undefined ? '' :  row['Sede COD'],
                                                            Sede_DESC: row['Sede DESC'] == undefined ? '' :  row['Sede DESC'],
                                                            Referencia_COD: row['Referencia COD'] == undefined ? '' :  row['Referencia COD'],
                                                            Referencia_DESC: row['Referencia DESC'] == undefined ? '' :  row['Referencia DESC'],
                                                            Linea_COD: row['Linea COD'] == undefined ? '' :  row['Linea COD'],
                                                            Linea_DESC: row['Linea DESC'] == undefined ? '' :  row['Linea DESC'],
                                                            Unidad_Negocio_PC_COD: row['Unidad Negocio PC COD'] == undefined ? '' :  row['Unidad Negocio PC COD'],
                                                            Unidad_Negocio_PC_DESC: row['Unidad Negocio PC DESC'] == undefined ? '' :  row['Unidad Negocio PC DESC'],
                                                            Proyecto_COD: row['Proyecto COD'] == undefined ? '' :  row['Proyecto COD'],
                                                            Proyecto_DESC: row['Proyecto DESC'] == undefined ? '' :  row['Proyecto DESC'],
                                                            Actividad_Proyecto_COD: row['Actividad Proyecto COD'] == undefined ? '' :  row['Actividad Proyecto COD'],
                                                            Actividad_Proyecto_DESC: row['Actividad Proyecto DESC'] == undefined ? '' :  row['Actividad Proyecto DESC'],
                                                            Cd_Fondo_COD: row['Cd Fondo COD'] == undefined ? '' :  row['Cd Fondo COD'],
                                                            Cd_Fondo_DESC: row['Cd Fondo DESC'] == undefined ? '' :  row['Cd Fondo DESC'],
                                                            Cuenta_COD: row['Cuenta COD'] == undefined ? '' :  row['Cuenta COD'],
                                                            Cuenta_DESC: row['Cuenta DESC'] == undefined ? '' :  row['Cuenta DESC'],
                                                            Glosa: row['Glosa'] == undefined ? '' :  row['Glosa'],
                                                            Desc_Origen_Doc: row['Desc. Origen Doc'] == undefined ? '' :  row['Desc. Origen Doc'],
                                                            Desc_Nro_Doc: row['Desc. Nro Doc'] == undefined ? '' :  row['Desc. Nro Doc'],
                                                            Desc_Tipo_Doc: row['Desc. Tipo Doc'] == undefined ? '' :  row['Desc. Tipo Doc'],
                                                            Registrador: row['Registrador'] == undefined ? '' :  row['Registrador'],
                                                            CliPro_Codigo: row[' Cli/Pro Codigo'] == undefined ? '' :  row[' Cli/Pro Codigo'],
                                                            CliPro_Nombre: row[' Cli/Pro Nombre'] == undefined ? '' :  row[' Cli/Pro Nombre'],
                                                            CliPro_Tipo_Doc: row[' Cli/Pro Tipo Doc'] == undefined ? '' :  row[' Cli/Pro Tipo Doc'],
                                                            CliPro_Númer_Doc: row[' Cli/Pro Número Doc'] == undefined ? '' :  row[' Cli/Pro Número Doc'],
                                                            Fecha_Factura: row['Fecha Factura'] == undefined ? '' :  row['Fecha Factura'],
                                                            Documento_Relacionado: row['Documento Relacionado'] == undefined ? '' :  row['Documento Relacionado'],
                                                            Moneda_Origen: row['Moneda Origen'] == undefined ? '' :  row['Moneda Origen'],
                                                            Fecha_Pago: row['Fecha Pago'] == undefined ? '' :  row['Fecha Pago'],
                                                            Igv_Tipo_Uso: row['Igv Tipo Uso'] == undefined ? '' :  row['Igv Tipo Uso'],
                                                            Importe2: row['Importe2'] == undefined ? 0 :  row['Importe2'],
                                                            Importe_Dolares2: row['Importe_Dolares2'] == undefined ? 0 :  row['Importe_Dolares2']
                                                      }
