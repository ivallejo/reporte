...
CustomFile = function(elem, options){
	...
	this.defaults = {
		...
		messages : {
			...
			errorMaxMB : "Peso total excedido",
			errorFileKB : "Archivo demasiado pesado",
			errorMaxFiles : "Se alcanzó el número máximo de archivos",
			errorBigImage : "Imagen demasiado grande",
			errorSmallImage : "Imagen demasiado pequeña",
			errorOnReading : "Aplicación ocupada. Por favor, inténtelo de nuevo más tarde.",
			errorMultipleDisable : "Arrastra y suelta un archivo a la vez."
		},
		popup : {
			active : true,
			autoclose : true,
